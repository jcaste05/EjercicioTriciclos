...
'''
Programa que toma como entrada los ficheros que forman el grafo e imprime por
...
def main(sc, ficheros):
    grafo_txt = sc.parallelize([])
    for f in ficheros: #Recorremos los ficheros y juntamos todo en un rdd
        fichero_rdd = sc.textFile(f)
        grafo_txt = grafo_txt.union(fichero_rdd)
